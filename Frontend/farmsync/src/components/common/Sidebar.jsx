  ...
  return (
    <aside className="sticky top-0 z-20 flex h-screen w-64 flex-col border-r border-farm-border bg-farm-sidebar text-gray-300">
      ...
      <div className="mt-auto p-4 pb-5">
        ...
        <button className="flex w-full items-center justify-between rounded-xl border border-farm-border px-4 py-3 text-sm text-gray-300 transition-colors hover:bg-farm-border/50">
